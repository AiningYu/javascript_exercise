...
// const arr4 = [1, 5, 3, 9, 0];
// const quickSort = function(sortArr) {
//     if (sortArr.length <= 1) {
//         return sortArr;
//     }
//
//     let pivot = sortArr[Math.floor(sortArr.length/2)];
//
//     let left = [];
//     let right = [];
//
//     for (let i = 0; i < sortArr.length; i++) {
//         if (i === Math.floor(sortArr.length / 2)) {
//                 continue;
//         }
//         if (sortArr[i] < pivot) {
//             left.push(sortArr[i]);
...
//
//
// const inputStr = "aregqerhhh";
// function duplicateRemoval(inputStr) {
//     return [...new Set(inputStr)].join('');
// }
// console.log(duplicateRemoval(inputStr));
//
